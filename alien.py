...
\033[0;32m      _                      _______                      _
\033[0;32m   _dMMMb._              .adOOOOOOOOOba.              _,dMMMb_
\033[0;32m  dP'  ~YMMb            dOOOOOOOOOOOOOOOb            aMMP~  `Yb
\033[0;32m  V      ~"Mb          dOOOOOOOOOOOOOOOOOb          dM"~      V
\033[0;32m           `Mb.       dOOOOOOOOOOOOOOOOOOOb       ,dM'
\033[0;36m            `YMb._   |OOOOOOOOOOOOOOOOOOOOO|   _,dMP'
\033[0;36m       __     `YMMM| OP'~"YOOOOOOOOOOOP"~`YO |MMMP'     __
\033[0;36m     ,dMMMb.     ~~' OO     `YOOOOOP'     OO `~~     ,dMMMb.
\033[0;36m  _,dP~  `YMba_      OOb      `OOO'      dOO      _aMMP'  ~Yb._
\033[0;36m <MMP'     `~YMMa_   YOOo   @  OOO  @   oOOP   _adMP~'      `YMM>
\033[0;94m              `YMMMM\`OOOo     OOO     oOOO'/MMMMP'
\033[0;94m      ,aa.     `~YMMb `OOOb._,dOOOb._,dOOO'dMMP~'       ,aa.
\033[0;94m    ,dMYYMba._         `OOOOOOOOOOOOOOOOO'          _,adMYYMb.
\033[0;94m   ,MP'   `YMMba._      OOOOOOOOOOOOOOOOO       _,adMMP'   `YM.
\033[0;94m   MP'        ~YMMMba._ YOOOOPVVVVVYOOOOP  _,adMMMMP~       `YM
\033[0;96m   YMb           ~YMMMM\`OOOOI`````IOOOOO'/MMMMP~           dMP
\033[0;96m    `Mb.           `YMMMb`OOOI,,,,,IOOOO'dMMMP'           ,dM'
\033[0;96m      `'                  `OObNNNNNdOO'                   `'
\033[0;96m                            `~OOOOO~'   
...
\033[0;94m██║░░██║███████╗██║███████╗██║░╚███║
\033[0;94m╚═╝░░╚═╝╚══════╝╚═╝╚══════╝╚═╝░░╚══╝
 𝖂𝖆𝖗𝖓𝖎𝖓𝖌 𝔡𝔬𝔫,𝔱 𝔢𝔡𝔦𝔱 𝔪𝔶 𝔰𝔠𝔯𝔦𝔭𝔱 𝔪𝔬𝔯𝔢
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Nouman-aziz
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://https://www.facebook.com/profile.php?id=100046773248216')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;94mnoumanaziz\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mnoumamaziz\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mAlien start cloning Wait...')
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mNouman-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mNouman-Checkpoint'
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\0make•◈•▬ ▬ ▬•◈\033[1;91mNouman-aziz\033[1;95m◈•▬ ▬ ▬•◈•"
	print "\033[1;91m«---•◈•---Developed By M-Nouman-aziz--•◈•---»" #Dev:Nouman-aziz
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 alien.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Nouman aziz Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Instagram
              \033[1;91mNoumifbtricker005"""
